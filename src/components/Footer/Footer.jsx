      ...
      <footer className={classes.footer}>
        <Grid container spacing={16}>
          <Hidden smDown>
            ...
            <Grid item md={3}>
              <Typography variant="h5" align="center" gutterBottom color={'inherit'} className={classes.footerText}>
                Contato
              </Typography>
            ...
            <Grid item xs={12} md={5}>
              <Typography variant="h5"  gutterBottom color={'inherit'} className={classes.footerText}>
                FGV EESP <br/>
